 ...
 * @module   pool/module-column/src/layout/module
 */
NEJ.define([
    'base/klass',
     ...
     * Layout 模块
     *
     * @class   module:pool/module-column/src/layout/module.Layout
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var Layout = k._$klass();
    pro = Layout._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/layout/module.Layout#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/layout/module.Layout#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/layout/module.Layout#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/layout/module.Layout#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/layout/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,Layout);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/layout/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,Layout);
