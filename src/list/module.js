 ...
 * @module   pool/module-column/src/list/module
 */
NEJ.define([
    'base/klass',
     ...
     * List 模块
     *
     * @class   module:pool/module-column/src/list/module.List
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var List = k._$klass();
    pro = List._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/list/module.List#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/list/module.List#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/list/module.List#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/list/module.List#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/list/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,List);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/list/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,List);
