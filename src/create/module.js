 ...
 * @module   pool/module-column/src/create/module
 */
NEJ.define([
    'base/klass',
     ...
     * Create 模块
     *
     * @class   module:pool/module-column/src/create/module.Create
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var Create = k._$klass();
    pro = Create._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/create/module.Create#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/create/module.Create#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/create/module.Create#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/create/module.Create#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/create/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,Create);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/create/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,Create);
