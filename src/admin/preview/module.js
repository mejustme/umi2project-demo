 ...
 * @module   pool/module-column/src/admin/preview/module
 */
NEJ.define([
    'base/klass',
     ...
     * AdminPreview 模块
     *
     * @class   module:pool/module-column/src/admin/preview/module.AdminPreview
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminPreview = k._$klass();
    pro = AdminPreview._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/preview/module.AdminPreview#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/preview/module.AdminPreview#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/preview/module.AdminPreview#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/preview/module.AdminPreview#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/preview/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminPreview);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/preview/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminPreview);
    
    // 导出模块
    exports.AdminPreview = AdminPreview;
});