 ...
 * @module   pool/module-column/src/admin/module
 */
NEJ.define([
    'base/klass',
     ...
     * Admin 模块
     *
     * @class   module:pool/module-column/src/admin/module.Admin
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var Admin = k._$klass();
    pro = Admin._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/module.Admin#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/module.Admin#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/module.Admin#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/module.Admin#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,Admin);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,Admin);
