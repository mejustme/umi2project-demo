 ...
 * @module   pool/module-column/src/admin/list/module
 */
NEJ.define([
    'base/klass',
     ...
     * AdminList 模块
     *
     * @class   module:pool/module-column/src/admin/list/module.AdminList
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminList = k._$klass();
    pro = AdminList._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/list/module.AdminList#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/list/module.AdminList#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/list/module.AdminList#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/list/module.AdminList#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/list/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminList);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/list/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminList);
