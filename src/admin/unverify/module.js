...
NEJ.define([
     ...
     * AdminUnverify 模块
     *
     * @class   module:pool/module-column/src/admin/unverify/module.AdminUnverify
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminUnverify = k._$klass();
    pro = AdminUnverify._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/module.AdminUnverify#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/module.AdminUnverify#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/module.AdminUnverify#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/module.AdminUnverify#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/unverify/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminUnverify);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/unverify/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminUnverify);
    
    // 导出模块
    exports.AdminUnverify = AdminUnverify;
});