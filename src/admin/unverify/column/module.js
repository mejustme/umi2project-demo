/**
 * AdminUnverifyColumn 模块实现文件
 *
 * @version  1.0
 * @author   hzchenqinhui@corp.netease.com <hzchenqinhui@corp.netease.com@corp.netease.com>
 * @module   pool/module-column/src/admin/unverify/column/module
 */
NEJ.define([
    'base/klass',
    ...
    /**
     * AdminUnverifyColumn 模块
     *
     * @class   module:pool/module-column/src/admin/unverify/column/module.AdminUnverifyColumn
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminUnverifyColumn = k._$klass();
    pro = AdminUnverifyColumn._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/column/module.AdminUnverifyColumn#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/column/module.AdminUnverifyColumn#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/column/module.AdminUnverifyColumn#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/unverify/column/module.AdminUnverifyColumn#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/unverify/column/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminUnverifyColumn);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/unverify/column/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminUnverifyColumn);
    
    // 导出模块
    exports.AdminUnverifyColumn = AdminUnverifyColumn;
});