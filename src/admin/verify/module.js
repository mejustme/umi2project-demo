 ...
 * @module   pool/module-column/src/admin/verify/module
 */
NEJ.define([
    'base/klass',
     ...
     * AdminVerify 模块
     *
     * @class   module:pool/module-column/src/admin/verify/module.AdminVerify
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminVerify = k._$klass();
    pro = AdminVerify._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/verify/module.AdminVerify#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/module.AdminVerify#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/module.AdminVerify#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/module.AdminVerify#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/verify/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminVerify);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/verify/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminVerify);
