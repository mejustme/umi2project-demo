...
NEJ.define([
    ...
    /**
     * AdminVerifyColumn 模块
     *
     * @class   module:pool/module-column/src/admin/verify/column/module.AdminVerifyColumn
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var AdminVerifyColumn = k._$klass();
    pro = AdminVerifyColumn._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/admin/verify/column/module.AdminVerifyColumn#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/column/module.AdminVerifyColumn#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/column/module.AdminVerifyColumn#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/admin/verify/column/module.AdminVerifyColumn#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/admin/verify/column/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,AdminVerifyColumn);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/admin/verify/column/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,AdminVerifyColumn);
    
    // 导出模块
    exports.AdminVerifyColumn = AdminVerifyColumn;
});