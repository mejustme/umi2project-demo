 ...
 * @module   pool/module-column/src/manage/topbar/module
 */
NEJ.define([
    'base/klass',
     ...
     * ManageTopbar 模块
     *
     * @class   module:pool/module-column/src/manage/topbar/module.ManageTopbar
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var ManageTopbar = k._$klass();
    pro = ManageTopbar._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/module.ManageTopbar#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/module.ManageTopbar#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/module.ManageTopbar#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/module.ManageTopbar#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/topbar/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,ManageTopbar);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/topbar/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,ManageTopbar);
    
    // 导出模块
    exports.ManageTopbar = ManageTopbar;
});