...
NEJ.define([
     ...
     * ManageTopbarList 模块
     *
     * @class   module:pool/module-column/src/manage/topbar/list/module.ManageTopbarList
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var ManageTopbarList = k._$klass();
    pro = ManageTopbarList._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/list/module.ManageTopbarList#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/list/module.ManageTopbarList#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/list/module.ManageTopbarList#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/list/module.ManageTopbarList#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/topbar/list/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,ManageTopbarList);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/topbar/list/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,ManageTopbarList);
    
    // 导出模块
    exports.ManageTopbarList = ManageTopbarList;
});