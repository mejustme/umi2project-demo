...
NEJ.define([
    ...
    /**
     * ManageTopbarDraft 模块
     *
     * @class   module:pool/module-column/src/manage/topbar/draft/module.ManageTopbarDraft
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var ManageTopbarDraft = k._$klass();
    pro = ManageTopbarDraft._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/draft/module.ManageTopbarDraft#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/draft/module.ManageTopbarDraft#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/draft/module.ManageTopbarDraft#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/draft/module.ManageTopbarDraft#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/topbar/draft/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,ManageTopbarDraft);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/topbar/draft/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,ManageTopbarDraft);
    
    // 导出模块
    exports.ManageTopbarDraft = ManageTopbarDraft;
});