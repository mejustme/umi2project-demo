...
NEJ.define([
     ...
     * ManageTopbarInfo 模块
     *
     * @class   module:pool/module-column/src/manage/topbar/info/module.ManageTopbarInfo
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var ManageTopbarInfo = k._$klass();
    pro = ManageTopbarInfo._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/info/module.ManageTopbarInfo#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/info/module.ManageTopbarInfo#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/info/module.ManageTopbarInfo#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/topbar/info/module.ManageTopbarInfo#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/topbar/info/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,ManageTopbarInfo);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/topbar/info/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,ManageTopbarInfo);
    
    // 导出模块
    exports.ManageTopbarInfo = ManageTopbarInfo;
});