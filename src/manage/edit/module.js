 ...
 * @module   pool/module-column/src/manage/edit/module
 */
NEJ.define([
    'base/klass',
     ...
     * ManageEdit 模块
     *
     * @class   module:pool/module-column/src/manage/edit/module.ManageEdit
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var ManageEdit = k._$klass();
    pro = ManageEdit._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/edit/module.ManageEdit#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/edit/module.ManageEdit#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/edit/module.ManageEdit#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/edit/module.ManageEdit#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/edit/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,ManageEdit);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/edit/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,ManageEdit);
    
    // 导出模块
    exports.ManageEdit = ManageEdit;
});