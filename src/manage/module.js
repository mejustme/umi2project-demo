 ...
 * @module   pool/module-column/src/manage/module
 */
NEJ.define([
    'base/klass',
     ...
     * Manage 模块
     *
     * @class   module:pool/module-column/src/manage/module.Manage
     * @extends module:pool/module-base/src/base.Module
     *
     * @param {Object} options - 模块构造参数
     */
    var Manage = k._$klass();
    pro = Manage._$extend(m.Module);
     ...
     * 
     * @protected
     * @method  module:pool/module-column/src/manage/module.Manage#_doBuild
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/module.Manage#_onShow
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/module.Manage#_onRefresh
     ...
     *
     * @protected
     * @method  module:pool/module-column/src/manage/module.Manage#_onHide
     * @returns {void}
     */
     ...
     * 构建模块
     *
     * @method module:pool/module-column/src/manage/module.build
     * @param {Object} options - 模块配置参数
     * @see   {@link module:pool/module-base/src/base.build}
     */
    exports.build  = m.build._$bind(m,Manage);
    
    /**
     * 注册模块
     *
     * @method module:pool/module-column/src/manage/module.regist
     * @param {String} umi - 模块UMI或者别名
     * @see   {@link module:pool/module-base/src/base.regist}
     */
    exports.regist = m.regist._$bind2(m,Manage);
